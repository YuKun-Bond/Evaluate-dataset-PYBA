...
for model_name in model_names:
    for number2 in range(1, 2, 1):
        ...
        #紀錄評分文字
        updated_assistant_reply = get_score_by_model("gemini", prompt + "\n\n" + Q + "\n" + A)
        ...
        with open(f'First-Scoring-result-Gemini/{model_name}.json', 'w', encoding='utf-8') as json_file:
            json.dump(outputs_list, json_file, ensure_ascii=False, indent=2)

        with open(f'First-Scoring-result-Gemini-ALL/{model_name}-ALL.json', 'w', encoding='utf-8') as json_file:
